...
?>
<section class="post-section fc__img-text bg-colour-double q-bg-img-dark">
  <div class="white-overlay d-lg-none d-block position-absolute"></div>
  <div class="container">
    <div class="row py-lg-5 py-4">
      <!-- -->
      <div class="col-12 col-lg-5 fc__img-text-text d-flex align-items-center mb-lg-0 mb-5">
      ...
      <div class="col-12 col-lg-7 fc__img-text-img d-flex align-items-center">
        <figure>
    ...
    <div class="row py-lg-5 py-4">
      <!-- -->
      <div class="col-12 col-lg-7 fc__img-text-img d-flex order-lg-1 order-5 align-items-center">
        <figure>
          <?= wp_get_attachment_image($block_bottom['img']['id'], 'large') ?>
        </figure>
      </div>
      <div class="col-12 col-lg-5 fc__img-text-text d-flex order-lg-5 order-1 align-items-center mb-lg-0 mb-5">
